...
import { Check, Crown, Loader2, LogOut, MoreVertical, ShieldHalf, ShieldQuestion, Sword } from "lucide-react";
                                ...
                                <div className="ml-auto">
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent side="left">
                                            ...
                                            <DropdownMenuSeparator />
                                            <DropdownMenuItem onClick={() => onRemove(member.id)} className="text-rose-500">
